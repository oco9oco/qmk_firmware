...
//clang-format off
 [_BASE] = LAYOUT_ID75_wrapper( /* QWERTY */
    ...
    KC_CAPS,   __________________QWERTY_SACS_L2___________,      KC_F6,   XXXXXXX, KC_GRAVE,      __________________QWERTY_R2________________,  KC_QUOT,
    KC_LSFT,   LGUI_T(KC_Z),KC_X,KC_C,    KC_V,    KC_B,         KC_F7,   XXXXXXX, KC_B,          __________________QWERTY_R3________________,  KC_BSLS,

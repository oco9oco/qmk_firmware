...
//clang-format off
 [_BASE] = LAYOUT_ID75_wrapper( /* QWERTY */
    ...
    KC_LCTL,   KC_LGUI, KC_LALT, THUMB_L3,THUMB_L1,THUMB_L2,     KC_LEFT, KC_DOWN, KC_RGHT,       THUMB_R2,THUMB_R3,THUMB_R1,KC_LANG2, KC_LBRC, KC_RBRC
 ),

 [_BASE_NOMOD] = LAYOUT_ID75_wrapper( /* QWERTY */
    _______,   _______, _______, _______, _______, _______,      _______, _______, _______,       _______, _______, _______, _______, _______,  _______, 
    _______,   _______, _______, _______, _______, _______,      _______, _______, _______,       _______, _______, _______, _______, _______,  _______, 
    _______,   __________________QWERTY_L2________________,      _______, TO_BASE, _______,       __________________QWERTY_R2________________,  _______, 
    _______,   _______, _______, _______, _______, _______,      _______, _______, _______,       _______, _______, _______, _______, _______,  _______, 
    _______,   _______, _______, _______, _______, _______,      _______, _______, _______,       _______, _______, _______, _______, _______,  _______  
 ),

...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
               MO(_SETTINGS),  KC_LALT, THUMB_L1,THUMB_L2,THUMB_L3,         THUMB_R3,THUMB_R2,THUMB_R1,KC_HANJA, MO(_SETTINGS)
),
...
// const key_override_t haen_hanja_override = ko_make_basic(MOD_MASK_SHIFT, KC_HAEN, KC_HANJA);   
